...
def ensure_ccw_poly(polygon: Polygon) -> Polygon:
  ...
  return Polygon(shell=ensure_ccw_ring(polygon.exterior), holes=[ensure_ccw_ring(hole) for hole in polygon.interiors])
...
def ensure_cw_poly(polygon: Polygon) -> Polygon:
  ...
  return Polygon(shell=ensure_cw_ring(polygon.exterior), holes=[ensure_cw_ring(hole) for hole in polygon.interiors])
